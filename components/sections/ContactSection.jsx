...
const campuses = [
  ...
  },
  {
    ...
    phone: "+91 - 94980 70404",
    mapSrc:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.5!2d80.2305!3d13.1527!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5264000000000%3A0x0!2sMadhavaram%2C+Chennai!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin",
  },
];
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {campuses.map((campus, idx) => (
                <motion.button
                  ...
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  className={`relative text-left p-5 rounded-xl border-2 transition-all duration-300 cursor-pointer group ${activeCampus === idx
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 transition-colors duration-300 ${activeCampus === idx
                    ...
                    <div>
                      <h4
                        className={`font-bold text-base mb-1 transition-colors duration-300 ${activeCampus === idx
                          ? "text-brand-primary"
                          : "text-gray-800"
                          }`}
                      >
            ...
            <div className="flex items-center justify-center gap-3 mt-5">
              {campuses.map((campus, idx) => (
                <button
                  key={campus.id}
                  onClick={() => setActiveCampus(idx)}
                  className={`px-4 py-2 rounded-full text-xs font-bold tracking-wide transition-all duration-300 cursor-pointer ${activeCampus === idx
